	...
	<body class="caio-f">
		<div class="body-overflow">
					...
					<div class="container-fluid no-padding">
						<div class="row">
							<div class="col-12">
								...
								<div class="image" style="background-image: url('assets/img/banner-caio-f.jpg');">
							...
							<div class="col-lg-6 left">
								...
								<div class="image">
									...
									<div class="yellow-circle">
										<?php include('assets/svg/doodle.php') ?>
									</div>
									...
									<img src="assets/img/caio-f.jpg" alt="Caio F. | Foto: Juvenal Pereira">
						...
						<div class="row">
							<div class="col-12">
								...
								<h3 class="title-medium title">
									Toda a obra de Caio F. tem direito autoral relacionado com a família:
								</h3>
									...
									<div class="gallery-slider swiper-container">
										<div class="swiper-wrapper">
											...
											<div class="swiper-slide">
												<a href="assets/img/gallery-01.jpg" data-fancybox="gallery" class="gallery-block">
													...
													<div class="thumbnail">
														<img src="assets/img/gallery-01.jpg" alt="Foto: Adriana Franciosi">
													</div>
											...
											<div class="swiper-slide">
												<a href="assets/img/gallery-02.jpg" data-fancybox="gallery" class="gallery-block">
													...
													<div class="thumbnail">
														<img src="assets/img/gallery-02.jpg" alt="Arquivo da Família">
													</div>
											...
											<div class="swiper-slide">
												<a href="assets/img/gallery-03.jpg" data-fancybox="gallery" class="gallery-block">
													...
													<div class="thumbnail">
														<img src="assets/img/gallery-03.jpg" alt="Foto: Adriana Franciosi">
													</div>
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="grid text-big">
									...
									<a href="#" target="_blank" style="background-image: url('assets/img/library-01.jpg');">
										<p>Notion</p>
									</a>

									<a href="#" target="_blank" style="background-image: url('assets/img/library-02.jpg');">
										<p>Cartas, Contos e Crônicas</p>
									</a>

									<a href="#" target="_blank" style="background-image: url('assets/img/library-03.jpg');">
										<p>Áudios</p>
									</a>

									<a href="#" target="_blank" style="background-image: url('assets/img/library-04.jpg');">
										<p>Cinema</p>
									</a>

									<a href="#" target="_blank" style="background-image: url('assets/img/library-05.jpg');">
										<p>Entrevistas</p>
									</a>

									<a href="#" target="_blank" style="background-image: url('assets/img/library-06.jpg');">
			...
			<footer>
				...
				<script src="assets/js/caio-f.js" defer></script>
			</footer>
